...
address: UiO, Blindern, Georg Sverdrups hus, DSC Oasen      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: 59.938744        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: 10.720808       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: 28. November 2024    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: 9:00 am - ca. 3:00 pm CET    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2024-11-28      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2024-11-28         # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Désirée Treichler", "Federico Bianchini"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Gisela Attinger", "Nicholas David Yardley Ball"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
